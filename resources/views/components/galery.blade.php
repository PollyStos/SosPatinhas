...
<section class="py-5 text-center" style="background-color: {{$bg}}">
    ...
    @if(isset($page))
        ...
        <div class="my-5 d-flex flex-wrap justify-content-center">
            <button class="btn_lost_found px-5 py-1 font-semibold mx-1 mb-2 bg_color_light color_primary border-0" data-filter="all">Todos</button>
            <button class="btn_lost_found px-5 py-1 font-semibold mx-1 mb-2 bg_color_primary color_white border-0" data-filter="found">Achados</button>
            <button class="btn_lost_found px-5 py-1 font-semibold mx-1 mb-2 bg_color_primary color_white border-0" data-filter="lost">Perdidos</button>
        </div>

        {{-- Filtro por raça --}}
        <div class="my-5 d-flex flex-wrap justify-content-center">
            <button class="btn_type_filter px-5 py-1 rounded-pill font-semibold mx-1 mb-2 bg_color_primary color_white border-0" data-type="all">Todos</button>
            <button class="btn_type_filter px-5 py-1 rounded-pill font-semibold mx-1 mb-2 bg_color_light color_primary border-0" data-type="cat">Gatos</button>
            <button class="btn_type_filter px-5 py-1 rounded-pill font-semibold mx-1 mb-2 bg_color_light color_primary border-0" data-type="dog">Cachorros</button>
        </div>
    @endif
